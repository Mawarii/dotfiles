...
You can do this with kustomize and add this snippet to the patches section. The `cronjob-backup.patch.yaml` template file can be found [here](./examples/cronjob-backup.patch.yaml) and should be copied into your project folder.
