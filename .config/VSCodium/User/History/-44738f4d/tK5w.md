...
If you want to disable S3 upload you need to set the variable `ENABLE_LOCAL_BACKUP_ONLY` to the value *true* (default: *false*) and optionally `LOCAL_BACKUP_PATH` (default: */backup*).
