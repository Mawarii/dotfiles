...
func main() {
	...
	skillcategories := api.Group("/skill-categories")
	skillcategories.Get("/", controller.GetSkillCategories)
	skillcategories.Get("/:id", controller.GetSkillCategoryById)
	skillcategories.Post("/", middleware.JWTProtected, controller.CreateSkillCategory)
	skillcategories.Put("/:id", middleware.JWTProtected, controller.UpdateSkillCategory)
	skillcategories.Delete("/:id", middleware.JWTProtected, controller.DeleteSkillCategory)
