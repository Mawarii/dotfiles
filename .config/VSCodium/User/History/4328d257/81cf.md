...
In some cases you want to add a custom CA to your Keycloak instance. To achieve this you'll have to do some tweaks to your compose file. (Note every line with comments.):
...
services:
  keycloak:
    ...
    environment:
      ...
      - KC_SPI_TRUSTSTORE_FILE_FILE=/opt/keycloak/cacerts # add CA certs path ENV
      - KC_SPI_TRUSTSTORE_FILE_PASSWORD=changeit # add CA password ENV
    ports:
      - 8080:8080
    depends_on:
      - keycloak-db
