...
while true; do
  result=$(curl --silent --request GET \
    "https://gitlab.publicplan.cloud/api/v4/projects/706/merge_requests?search=$SEARCH_QUERY&per_page=100&page=$page&state=opened" \
...
for id in "${ids[@]}"; do
    ...
    curl --silent --request PUT \
      "https://gitlab.publicplan.cloud/api/v4/projects/706/merge_requests/$id" \
      --header "PRIVATE-TOKEN: $GITLAB_ACCESS_TOKEN" \
