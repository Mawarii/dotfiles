...
After creating a backup from the cluster above the cluster is suddenly gone (`kubectl delete cluster postgresql-cluster`). To restore you have to edit the cluster manifest as follows:
