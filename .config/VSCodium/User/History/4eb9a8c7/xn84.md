...
You can copy paste this file to the new repository: `iac/efa/applications/<your-application>/<stage>`. Details to the new repository structure can be found [here](wsp-migration-guide.md).
