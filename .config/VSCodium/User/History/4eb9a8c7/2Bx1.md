...
metadata:
  labels:
    app.kubernetes.io/instance: empfangsclient
    gitlab.publicplan.cloud/primary-application-project-id: "627"
    gitlab.publicplan.cloud/primary-application-project-release-branch: develop
  name: empfangsclient-fitko
  namespace: argocd
spec:
  destination:
    namespace: empfangsclient-fitko
    server: 'https://kubernetes.default.svc'
  project: efacluster-empfangsclient
  sources:
  - path: helm/vault/develop/fitko/resources
    repoURL: 'git@gitlab.publicplan.cloud:iac/efa/distributions/empfangsclient/argo-test.git'
    targetRevision: main
  - path: helm/keycloak/develop/fitko/resources
    repoURL: 'git@gitlab.publicplan.cloud:iac/efa/distributions/empfangsclient/argo-test.git'
    targetRevision: main
  - path: kustomization/overlays/develop/fitko
    repoURL: 'git@gitlab.publicplan.cloud:iac/efa/distributions/empfangsclient/argo-test.git'
    targetRevision: main
  syncPolicy:
    automated:
