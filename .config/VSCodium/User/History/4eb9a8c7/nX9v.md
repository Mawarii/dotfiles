...
You can copy paste this file to the new repository: `iac/efa/applications/<your-application>/<stage>`. Details to the new repository structure can be found [here](operations/Infrastructure/Clusters/EfA/gitlab-repository-structure).
